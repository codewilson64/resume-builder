...
const CTA = () => {
  return (
    <section className="relative overflow-hidden py-40 px-6 bg-gradient-to-br from-cyan-100 via-white to-blue-50">
      ...
      <div className="absolute top-10 left-10 w-24 h-24 bg-cyan-300 rounded-xl opacity-30 rotate-12"></div>
